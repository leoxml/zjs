...
class Http
{
     ...
     * @return array
     */
    public function get($url, $params = array(), $option = array())
    {
        return $this->request($url, self::GET, $params, $option);
    }
     ...
     * @return array
     */
    public function post($url, $params = array(), $option = array())
    {
        return $this->request($url, self::POST, $params, $option);
    }
     ...
     * @return array
     */
    public function put($url, $params = array(), $option = array())
    {
        return $this->request($url, self::PUT, $params, $option);
    }
     ...
     * @return array
     */
    public function patch($url, $params = array(), $option = array())
    {
        return $this->request($url, self::PATCH, $params, $option);
    }
     ...
     * @return array
     */
    public function delete($url, $params = array(), $option = array())
    {
        return $this->request($url, self::DELETE, $params, $option);
    }
